...
export default function Navbar() {
    ...
    return (
        ...
        <div className="md:container container-fluid fixed min-w-full backdrop-blur-sm bg-white z-50 ">
                ...
                <div className="max-w-screen-xl flex flex-row justify-between mx-auto px-4 py-3">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link onClick={scrollTopFunc} to="/" className="mr-3 w-8">
                            <img src="/images/logo-main.svg" className="w-full" alt="Emirates Elegance" />
                        </Link>
                        ...
                        <div className='hidden lg:block'>
                            <NavigationMenu>
                                <NavigationMenuList>
                                            ...
                                            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                                    ...
                                                    <NavigationMenuLink asChild>
                                                        ...
                                                        >
                                                            <div className="mb-2 mt-4 text-lg font-bold text-white">
                                                                Discover Jewelleries
                                                            </div>
                                                            <p className="text-sm leading-tight text-white">
                                                                Explore our extensive range of luxurious jewelleries
                                                            </p>
                                                        </Link>
                                                    </NavigationMenuLink>
                                                </li>
                                                ...
                                                <Link onClick={scrollTopFunc} to="/deals">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        ...
                                                        <p className="text-sm text-muted-foreground">Unlock special offers and exclusive discounts on premium jewelleries</p>
                                                    </li>
                                                </Link>
                                            </ul>
                                        </NavigationMenuContent>
                                            ...
                                            <ul className="grid gap-2 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                                <Link onClick={scrollTopFunc} to="/collections/luxury">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        ...
                                                        <p className="text-sm text-muted-foreground min-w-full">Be the first to own our latest designs.</p>
                                                    </li>
                                                </Link>
                                                <Link onClick={scrollTopFunc} to="/collections/fresh">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Limited Edition</span>
                                                        <p className="text-sm text-muted-foreground">Discover unique designs in limited supply.</p>
                                                    </li>
                                                </Link>
                                                <Link onClick={scrollTopFunc} to="/collections/warm">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Bestsellers</span>
                                                        <p className="text-sm text-muted-foreground">Shop our most-loved, timeless pieces.</p>
                                                    </li>
                                                </Link>
                                                <Link onClick={scrollTopFunc} to="/collections/unisex">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Exclusive Collection</span>
                                                        <p className="text-sm text-muted-foreground">Experience luxury with exclusive, premium pieces.</p>
                                                    </li>
                                                </Link>
                                                <Link onClick={scrollTopFunc} to="/collections/florals">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Customizable Jewelry</span>
                                                        <p className="text-sm text-muted-foreground">Create personalized jewelry for a unique touch.</p>
                                                    </li>
                                                </Link>
                                    ...
                                    {/* Jewelry section */}
                                    <NavigationMenuItem>
                                        <NavigationMenuTrigger className='bg-transparent'>Jewelry</NavigationMenuTrigger>
                                        <NavigationMenuContent>
                                            <ul className="grid gap-2 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-3">
                                                {/* Necklaces */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/necklaces">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Necklaces</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Elegant and timeless designs.</p>
                                                    </li>
                                                </Link>

                                                {/* Pendants */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/pendants">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Pendants</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Stylish pendants for every occasion.</p>
                                                    </li>
                                                </Link>

                                                {/* Chokers */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/chokers">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Chokers</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Bold chokers for a modern look.</p>
                                                    </li>
                                                </Link>

                                                {/* Earrings */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/earrings">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Earrings</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Beautiful designs for every ear.</p>
                                                    </li>
                                                </Link>

                                                {/* Bracelets */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/bracelets">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Bracelets</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Delicate and bold bracelet styles.</p>
                                                    </li>
                                                </Link>

                                                {/* Rings */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/rings">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Rings</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Glamorous rings for every occasion.</p>
                                                    </li>
                                                </Link>

                                                {/* Brooches */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/brooches">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Brooches</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Vintage and stylish brooch designs.</p>
                                                    </li>
                                                </Link>

                                                {/* Sets */}
                                                <Link onClick={scrollTopFunc} to="/jewelry/sets">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">Sets</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">Complete sets for coordinated style.</p>
                                                    </li>
                                                </Link>
                                            </ul>
                                        </NavigationMenuContent>
                                            ...
                                            <ul className="grid gap-2 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                                <Link onClick={scrollTopFunc} to="https://github.com//ashishmool/emirates-elegance" target="_blank">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        ...
                                                        <p className="text-sm text-muted-foreground min-w-full">by Sushmita Bishwakarma</p>
                                                    </li>
                                                </Link>
                                                <Link onClick={scrollTopFunc} to="/about">
                                                    <li className='hover:bg-gray-100 p-3 rounded-md'>
                                                        <span className="text-sm font-semibold">About Emirates Elegance</span>
                                                        <p className="text-sm text-muted-foreground min-w-full">The story behind Emirates Elegance.</p>
                                                    </li>
                                                </Link>
                                            </ul>
                                        </NavigationMenuContent>
                                        ...
                                        <PopoverContent className="w-80">
                                            <div className="grid gap-4">
                                                <div className="space-y-3">
                                                    ...
                                                    <h4 className="font-medium leading-none">Find Your Perfect Jewellery</h4>
                                                    <p className="text-sm text-muted-foreground">
                                                        Enter the keyword related to your search. For instance, "Gold Earring"
                                                    </p>
                                                    <p className="text-sm text-muted-foreground">
                                                ...
                                                <ul className="grid gap-1 p-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                                    ...
                                                    <Link onClick={scrollTopFunc} to="/discover">
                                                        <li className='hover:bg-gray-100 hover:font-semibold py-2 px-3 rounded-md'>
                                                            <span className="text-sm">Discover Jewelleries</span>
                                                        </li>
                                                    </Link>
                                                    <Link onClick={scrollTopFunc} to="/explore">
                                                        <li className='hover:bg-gray-100 hover:font-semibold py-2 px-3 rounded-md'>
