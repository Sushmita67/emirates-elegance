...
export default function Sell() {
    ...
    document.title = `Emirates Elegance | Sell New Jewellery`;
        ...
        <div>
            ...
            <header className="relative bg-[#F5F5F5] mt-10 py-20 md:py-32 lg:py-40 sm:rounded-xl overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center relative z-10">
                    <h1 className="text-4xl font-bold text-white mb-4">Sell Your Luxury Perfumes on Emirates Elegance</h1>
                    ...
                    <div className="max-w-3xl mx-auto grid gap-8">
                        <div>
                            ...
                            <p className="text-gray-500 mt-4 text-md">
                                Selling your luxury jewelleries on Emirates Elegance is easy. Simply follow these steps:
                            </p>
                ...
                <div className="grid gap-6 mb-12">
                    <div className="grid gap-2">
                        ...
                        <p className="text-gray-500">
                            Fill out the form below to list a new perfume product on Emirates Elegance.
                        </p>
                    </div>
                </div>
